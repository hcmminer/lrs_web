...
export class StationProgressReportService{
  ...
  searchReport(params: any, reportTypePath: string) {
    ...
    // return this.httpService.get(url, params, { responseType: 'text'}).pipe(
    //   catchError(err => {
    ...
    return this.http.get(
      ...
      url + ((params.province ? ('&province=' + params.province) : '')) + ((params.construction_type ? ('&construction_type=' + params.construction_type) : '')) + ((params.construction_status ? ('&construction_status=' + params.construction_status) : '')),
