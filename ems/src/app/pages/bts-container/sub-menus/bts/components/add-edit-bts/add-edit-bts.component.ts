...
@Component({
  selector: 'app-add-edit-bts',
  templateUrl: './add-edit-bts.component.html',
  styleUrls: ['./add-edit-bts.component.scss'],
})
export class AddEditBtsComponent implements OnInit, OnDestroy {
