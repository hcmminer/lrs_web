...
@Component({
  ...
  templateUrl: './form-add-edit-location.component.html',
  styleUrls: ['./form-add-edit-location.component.scss']
})
export class FormAddEditLocationComponent implements OnInit {
